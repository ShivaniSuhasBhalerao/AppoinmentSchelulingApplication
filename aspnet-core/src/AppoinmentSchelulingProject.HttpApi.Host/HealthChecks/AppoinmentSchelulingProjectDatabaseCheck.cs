...
public class AppoinmentSchelulingProjectDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AppoinmentSchelulingProjectDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
