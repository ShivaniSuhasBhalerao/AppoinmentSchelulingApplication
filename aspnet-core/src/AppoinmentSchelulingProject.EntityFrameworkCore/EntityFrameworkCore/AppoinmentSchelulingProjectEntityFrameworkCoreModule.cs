...
public class AppoinmentSchelulingProjectEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<AppoinmentSchelulingProjectDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also AppoinmentSchelulingProjectDbContextFactory for EF Core tooling. */
