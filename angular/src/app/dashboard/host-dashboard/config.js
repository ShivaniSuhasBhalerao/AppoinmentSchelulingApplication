...
window.config = {
  ...
  map: {
    ...
    'devextreme': 'npm:devextreme@22.1.5/cjs',
    'devextreme/bundles/dx.all': 'npm:devextreme@22.1.5/bundles/dx.all.js',
    'jszip': 'npm:jszip@3.7.1/dist/jszip.min.js',
    'devextreme-quill': 'npm:devextreme-quill@1.5.16/dist/dx-quill.min.js',
    'devexpress-diagram': 'npm:devexpress-diagram@2.1.63',
    'devexpress-gantt': 'npm:devexpress-gantt@4.1.32',
    'devextreme-angular': 'npm:devextreme-angular@22.1.5',
  ...
  packageConfigPaths: [
    ...
    'npm:devextreme-angular@22.1.5/*/package.json',
    'npm:devextreme-angular@22.1.5/ui/*/package.json',
    'npm:devextreme-angular@22.1.5/package.json',
    'npm:devexpress-diagram@2.1.63/package.json',
    'npm:devexpress-gantt@4.1.32/package.json',
  ],
};
